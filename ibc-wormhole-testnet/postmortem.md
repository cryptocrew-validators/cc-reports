Due to loosing peers on our private `gatewaytestnet` RPC node and connectivity problems with the public fallback, 6 clients have expired on either side of the chain pairs with the counterpartys below.
